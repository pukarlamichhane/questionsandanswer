...
function Asidebar() {
  ...
  return (
    <aside
      className={`sidebar-responsive fixed top-0 left-0 h-full bg-white-900 text-black w-64 mt-16 border-r border-gray-300`}
    >
      <ul className="sidebar-list p-0">
        <li
          className={`sidebar-list-item py-4 px-6 ${
            isDashboard ? "hover:bg-blue-800 hover:text-white" : ""
          }`}
        >
        ...
        <li className="sidebar-list-item py-4 px-6 hover:bg-blue-800 hover:text-white">
          <Link to="/admin/adduser" className="flex items-center">
